      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error occured during logging out, Try again later!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(type === 'data' ? 'updateMe' : 'updatePassword'),
              data: data
            });
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type === 'data' ? 'Data' : 'Password', " updated successfully"));
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXVkcml1czU5IiwiYSI6ImNrOTJ2eDEzajA3cmozaG90Y2JmaXljc2QifQ.fnf3HuJlPwFEf8xrJsifhg';
  ...
  locations.locations.forEach(function (loc) {
    ...
    el.className = 'marker'; //   add amrker
...
var stripe = Stripe('pk_test_BnNw97gvNUUqTzOC1xJpv773008z80Jmgh');
